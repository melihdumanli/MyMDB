package com.bilgeadam.clientside.menuitems;
...
public class MenuItems {
    ...
    public List<String> getLanQueryList() {
        ...
        lanQueryList.add("Bitte drücken Sie 3, um auf Deutsch fortzufahren.");
        return lanQueryList;
    }
    ...
    public void showMainMenu(ResourceBundle lang) {
        ...
        int choice;
        do {
            baUtils.menuBodyCreator(getMainMenuList(Globalization.getLanguageBundle()), Globalization.getLanguageBundle().getString("Globalization.CHOICEQUERY"));
